...
typedef struct HEVCDSPContext {
    ...
    void (*upsample_base_layer_frame)(AVFrame *FrameEL, AVFrame *FrameBL, short *Buffer[3], const int32_t enabled_up_sample_filter_luma[16][8], const int32_t enabled_up_sample_filter_chroma[16][4], struct HEVCWindow *Enhscal, struct UpsamplInf *upsaminfo);
} HEVCDSPContext;
